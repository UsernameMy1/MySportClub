<div class="footer">
      <header class="main-header">
        <div class="wrapper main-header__wrap">
          ...
          <?php
            ...
            $menu_id = $locations['si_menu_footer'];
          ...
          <?php
            if( is_active_sidebar('si-widget-footer-tel')){
                dynamic_sidebar('si-widget-footer-tel');
            }
        ?>
        </div>
      </header>
      <footer class="main-footer wrapper">
        <div class="row main-footer__row">
          ...
          <?php
            if( is_active_sidebar('si-widget-footer-start')){
                dynamic_sidebar('si-widget-footer-start');
            }
        ?>
